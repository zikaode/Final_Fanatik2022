        ...
        if ($request->jml_ps == "2") {
            ...
            if ($request->has('file_tp_1') && $request->has('file_tp_2') && $request->has('file_bp') && $request->has('file_kr')) {
                $validated = $request->validate([
                    'nama_kl' => 'required|unique:klm_webs,nama_kelompok',
                    'nama_1' => 'required',
                    ...
                    'file_kr' => 'required|mimes:zip,rar,tar,tar.gz|max:10192'
                ]);
                ...
                $request->file('file_kr')->storeAs('images/karya/web', $namafile_kr);

                $kelompok = KlmWeb::make([
                ...
                if ($kelompok->save()) {
                    $id_kelompok = KlmWeb::where('nama_kelompok', $request->nama_kl)->first();
                    $fotografiInsert_1 = Web::make([
                        'nama' => $request->nama_1,
                        ...
                        'klm_webs_id' => $id_kelompok->id
                    ]);
                    $fotografiInsert_2 = Web::make([
                        'nama' => $request->nama_2,
                    ...
                    if ($fotografiInsert_1->save() && $fotografiInsert_2->save()) {
                        return redirect('/registration/webdesign')->with('success', 'Data telah Terkirim..!')->withInput();
                    } else {
                        return redirect('/registration/webdesign')->with('failed', 'Data Tidak Terkirim..!')->withInput();
                    }
                } else {
                    return redirect('/registration/webdesign')->with('failed', 'Data Tidak Terkirim..!')->withInput();
                }
