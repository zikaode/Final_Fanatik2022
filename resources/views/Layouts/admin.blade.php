...
<body class="text-neutral-800 overflow-x-hidden">
    ...
    <nav class="bg-[#212129]">
        <div class="container mx-auto flex h-[80px] items-center px-6">
            ...
            <ul class="third hidden flex-1 basis-3/12 md:flex justify-end gap-6">
                ...
                <li class="text-[16px] text-gray-800 bg-white border-0 p-3 rounded-full space-x-2"><span><img
                            src="{{ asset('images/user.png') }}" class="w-[28px] h-[28px] inline-block"></span><span>-
                        {{ Auth::user()->name }} -</span><span><a
                            class="select-none inline-block align-middle p-2 border-0 rounded-full bg-[#212129]"
                            href="{{ route('logout') }}"
                            onclick="event.preventDefault();
                                          document.getElementById('logout-form').submit();"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                fill="currentColor" class="bi bi-box-arrow-right text-white " viewBox="0 0 16 16">
