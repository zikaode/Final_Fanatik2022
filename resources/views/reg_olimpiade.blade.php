...
@section('content')
    ...
    <div class="mx-4 p-5 mt-6 rounded-md border-2 border-slate-600 glass-white min-h-screen">
        <h2 class="text-2xl lg:text-3xl font-semibold text-center mb-5">PENDAFTARAN OLIMPIADE<br>FANATIK
            2022
            <hr class="mt-5">
        </h2>
        <div class="flex w-full h-full justify-between gap-4 flex-col lg:flex-row">
            <div class="flex-1 basis-6/12 space-y-4 order-2">
                ...
                @endif
                <form action="/registration/olimpiade" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
