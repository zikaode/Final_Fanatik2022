...
class TypingsController extends Controller
{
    /** 
    ...
    public function store(Request $request)
    {
        ...
        if ($request->has('file_tp') && $request->has('file_bp')) {
            ...
            if (!$typing->save()) {
                return redirect('/registration/typing')->with('failed', 'Data tidak Terkirim..!')->withInput();
            }
            return redirect('/registration/typing')->with('success', 'Data telah Terkirim..!')->withInput();
        } else {
            return redirect('/registration/typing')->with('failed', 'Data tidak Terkirim..!')->withInput();
        }
    }
