...
@section('content')
    ...
    <div class="mx-4 p-5 mt-6 rounded-md border-2 border-slate-600 glass-white min-h-screen">
        <h2 class="text-2xl lg:text-3xl font-semibold text-center mb-5">PENDAFTARAN WEB DESIGN<br>FANATIK
            2022
            <hr class="mt-5">
        </h2>
        <div class="flex w-full h-full justify-between gap-4 flex-col lg:flex-row">
            <div class="flex-1 basis-6/12 space-y-4 order-2">
                ...
                @endif
                <form action="/registration/webdesign" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
            ...
            <div
                ...
                <ul class="list-disc space-y-2">
                    <li>Peserta berasal dari SMA/SMK/Sederajat dengan dibuktikan wajib Melampirkan Pas Foto dan Kartu
                        Pelajar di form pendaftaran</li>
                    <li>1 Grup berisikan 2-3 orang peserta</li>
                    <li><span>Biaya Pendaftaran : Rp 40.000,-</span><br><span>Pendaftaran Dapat Melalui
                            Rekening: 7144140553 (M Fauzul Shalis)</span><br><span>Atau Melalui Dana: 085161123045 (Dzikri Arraiyan)</span></li>
                    <!--<li>Website(Front End) Dibuat dengan html, css, dan js vanilla</li>-->
